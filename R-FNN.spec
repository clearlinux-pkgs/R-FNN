...
Version  : 1.1.2.2
Release  : 13
URL      : https://cran.r-project.org/src/contrib/FNN_1.1.2.2.tar.gz
Source0  : https://cran.r-project.org/src/contrib/FNN_1.1.2.2.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1544546926
