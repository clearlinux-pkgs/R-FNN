...
Version  : 1.1.2.1
Release  : 12
URL      : https://cran.r-project.org/src/contrib/FNN_1.1.2.1.tar.gz
Source0  : https://cran.r-project.org/src/contrib/FNN_1.1.2.1.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1533909219
