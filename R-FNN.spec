...
Version  : 1.1.4.1
Release  : 56
URL      : https://cran.r-project.org/src/contrib/FNN_1.1.4.1.tar.gz
Source0  : https://cran.r-project.org/src/contrib/FNN_1.1.4.1.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1727042662
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/R/library/FNN/libs/FNN.so
/V4/usr/lib64/R/library/FNN/libs/FNN.so
